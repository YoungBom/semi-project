      ...
      <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/burger/edit" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" value="${burger.name}" required>
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="number" name="price" class="form-control" value="${burger.price}" required>
          </div>
          ...
          <div class="row g-2">
            ...
            <div class="col-6">
              <input type="number" name="calories" class="form-control"
                     value="${burger.details.calories}" placeholder="칼로리(kcal)" min="0">
            </div>

            <div class="col-6">
              <input type="number" name="carbohydrates" class="form-control"
                     value="${burger.details.carbohydrates}" placeholder="탄수화물(g)" min="0">
            </div>

            <div class="col-6">
              <input type="number" name="protein" class="form-control"
                     value="${burger.details.protein}" placeholder="단백질(g)" min="0">
            </div>

            <div class="col-6">
              <input type="number" name="fat" class="form-control"
                     value="${burger.details.fat}" placeholder="지방(g)" min="0">
            </div>

            <div class="col-6">
              <input type="number" name="sodium" class="form-control"
                     value="${burger.details.sodium}" placeholder="나트륨(mg)" min="0">
            </div>

            <div class="col-6">
              <input type="number" name="sugar" class="form-control"
                     value="${burger.details.sugar}" placeholder="당류(g)" min="0">
            </div>
          ...
          <button type="submit" class="btn-submit mt-4">수정하기</button>
        </form>
