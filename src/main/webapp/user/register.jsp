...
<body>
  ...
  <form method="post" action="<%=request.getContextPath()%>/register" autocomplete="off">
    <label>
      아이디(*)
    ...
    <label>
      비밀번호(*)
      <input type="password" name="user_pw" required minlength="8" maxlength="255"
             placeholder="8~20자 권장" autocomplete="new-password">
    </label>

    <label>
      비밀번호 확인(*)
      <input type="password" name="user_pw_confirm" required minlength="8" maxlength="255"
    ...
    <div class="row">
      ...
      <label>
        휴대폰(*)
        <input type="text" name="phone" maxlength="20" placeholder="010-0000-0000"
